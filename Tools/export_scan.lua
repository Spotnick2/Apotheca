...
--
--   lua5.1 Tools/export_scan.lua <WTF>/Account/<id>/SavedVariables/Apotheca.lua out.tsv
--
...
assert(scan, "no ApothecaDB.itemScan in " .. arg[1] .. " - run /apo scan and /apo scan2, then /reload")
local ids = {}
