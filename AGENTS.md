...
- Items are classified by what their tooltip says (instant restore, restore over time, "Heals N damage"), **not by subclass**: the client files Dense Runecloth Bandage, some potions and every battleground ration under "Other". Percentage restores, outdoor-zone-locked items and mage mana gems are reported as skipped, by policy.
