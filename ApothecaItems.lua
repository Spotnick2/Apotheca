...
--
-- GENERATED by Tools/build_item_tables.py from docs/forever-consumables-70009.tsv
-- (client build 70009). Do not edit by hand: re-scan in game and
...
D.BUFF_FOOD_BY_STAT = {
    agility = {
        { id = 238638, value = 25  },  -- Filet o' Flank (L55)
    ...
    strength = {
        { id = 238637, value = 25  },  -- Prowler Steak (L55)
